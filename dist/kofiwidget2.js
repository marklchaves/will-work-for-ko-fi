    ...
    (function () {
        ...
        return {
            init: function (pText, pColor, pId) {
                ...
                html +=
                    '<div class=btn-container><a title="Support me on ko-fi.com" class="kofi-button" style="background-color:[color];" href="https://ko-fi.com/[id]" target="_blank" rel="noopener noreferrer"> <span class="kofitext"><img src="https://storage.ko-fi.com/cdn/cup-border.png" class="kofiimg"/>[text]</span></a></div>';
            },
            getHTML: function () {
